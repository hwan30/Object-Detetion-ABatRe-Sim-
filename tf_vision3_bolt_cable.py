...
# this is set as a default but feel free to adjust it to your needs
 ...
 # iterate over all objects found
    ...
    stage_pub=rospy.Publisher("stage",Int32)
    ...
    if pick_stage==1:
        ...
        for i in range(min(max_boxes_to_draw, boxes.shape[0])):
            ...
            if int(detections['detection_classes'].numpy()[0][i] + 1)==3 and scores[i] > min_score_thresh:
    ...
    if pick_stage==2:
        ...
        for i in range(min(max_boxes_to_draw, boxes.shape[0])):
            ...
            if int(detections['detection_classes'].numpy()[0][i] + 1)==1 and scores[i] > min_score_thresh:
                class_id = int(detections['detection_classes'].numpy()[0][i] + 1)
                coordinates.append({
                "box": boxes[i],
                "class_name": category_index[class_id]["name"],
